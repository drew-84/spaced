    ...
    <div className="min-h-screen text-zinc-100">
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 py-12 sm:px-8">
        <section className="space-y-6 rounded-3xl border border-white/15 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-8 shadow-[0_30px_80px_rgba(0,0,0,0.45)]">
          <p className="inline-flex rounded-full border border-amber-300/35 bg-amber-300/15 px-3 py-1 text-xs font-medium text-amber-100">
        ...
        <section className="grid gap-5 sm:grid-cols-2">
          <Link
            href="/spaces"
            className="group rounded-2xl border border-white/15 bg-white/[0.04] p-6 shadow-[0_14px_30px_rgba(0,0,0,0.35)] transition hover:-translate-y-0.5 hover:border-amber-300/35 hover:bg-white/[0.07] hover:shadow-[0_16px_36px_rgba(245,158,11,0.22)]"
          >
            ...
            <p className="mt-5 text-sm font-medium text-zinc-200 group-hover:text-amber-100">
              Open discovery →
            </p>
          </Link>
