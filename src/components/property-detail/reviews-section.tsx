    ...
    <section aria-label="Reseñas" className="space-y-5">
      ...
      >
        <div className="flex items-baseline gap-3">
          ...
          <p className="text-[10px] uppercase tracking-[0.32em] text-white">
            / 5
          </p>
        </div>
          ...
          <article key={r.id} className={`relative ${GLASS_TILE} p-4 sm:p-5`}>
            <header className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-2.5">
                <span className="flex h-7 w-7 items-center justify-center rounded-full border border-white/20 bg-white/[0.06] text-[10px] font-medium uppercase tracking-[0.18em] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.18)]">
                  {r.alias.charAt(0)}
                </span>
